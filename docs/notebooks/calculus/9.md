...
=== "质心"
    ...
    $$
    \overline{x} = \dfrac{\int\limits_{\Omega} \mu(P) x \mathrm{d}\Omega}{\Omega} \quad \overline{y} = \dfrac{\int\limits_{\Omega} \mu(P) y \mathrm{d}\Omega}{\Omega} \quad \overline{z} = \dfrac{\int\limits_{\Omega} \mu(P) z \mathrm{d}\Omega}{\Omega}
    $$
