...
>注：大部分内容见[[Chap 3 Combinational Logical Design#Design Space|第3章]]，这里稍微谈一下CMOS电路，具体见[修佬的笔记](https://note.isshikih.top/cour_note/D2QD_DigitalDesign/Chap05/#cmos)和[wiki](https://en.wikipedia.org/wiki/CMOS)
...
CMOS晶体管的几何图形：
![300](./images/C5/Quicker_20240519_192814.png)

n-channel CMOS 和 p-channel CMOS：
![300](./images/C5/Quicker_20240519_192940.png)

使用CMOS晶体管构建开关电路的模型：
![300](./images/C5/Quicker_20240519_193135.png)
>注：左边表示$XY$，右边表示$X + Y$

CMOS的通用结构及其常见应用
![](./images/C5/Quicker_20240519_193230.png)
...
+ 大多数可编程逻辑设备是*可删除的(erasable)*，并且是*可重新编程的(reprogrammable)*
	...
	+ 允许将设备重用于不同的设计中
	+ 课程实验的理想选择
+ 可编程逻辑设备被用于原型设计，实现在常规IC的销售

### Programmable Logic Technologies

+ **连接控制(control connections)**
	+ mask programming
	![](./images/C5/Quicker_20240519_175713.png)
	+ 保险丝(fuse)：切断不想要的连接
	![](./images/C5/Quicker_20240519_154744.png)
	+ antifuse(具体见[wiki](https://en.wikipedia.org/wiki/Antifuse))：生成连接
	![](./images/C5/Quicker_20240519_154854.png)
+ **晶体管开关控制(control transistor switching)**
	...
	+ 在**浮栅(floating gate)** 上存储电荷		
		...
		+ 电子可删除
		+ 迅速（在闪存内）
	![](./images/C5/Quicker_20240519_155158.png)
>注：[浮栅](https://zh.wikipedia.org/wiki/%E6%B5%AE%E6%A0%85%E9%87%91%E5%B1%9E%E6%B0%A7%E5%8C%96%E7%89%A9%E5%8D%8A%E5%AF%BC%E4%BD%93%E5%9C%BA%E6%95%88%E5%BA%94%E6%99%B6%E4%BD%93%E7%AE%A1)

+ 查找表的构建(build lookup tables(LUT))
	+ 存储函数的元素
	🌰：3人投票器![](./images/C5/Quicker_20240519_155354.png)
...
+ **复杂可编程逻辑器件(complex programmable logic device, CPLD)/现场可编程逻辑门阵列(field-programmable gate array, FPGA)**：由于它相当复杂，因此被称为“建筑(architecture)”，此块内容略过

#### Configurations

![](./images/C5/Quicker_20240519_155955.png)

#### Logical Symbols

下面这些符号在本章后续部分将会经常用到，请务必弄清楚它们的含义！
![400](./images/C5/Quicker_20240519_193643.png)

![400](./images/C5/Quicker_20240519_160126.png)
...
![](./images/C5/Quicker_20240519_161404.png)



🌰 
1. $8 \times 4 \text{ ROM }$ ($N = 3 \text{ input lines, } M = 4 \text{ output lines}$)
![](./images/C5/Quicker_20240519_161748.png)
...
分析：
![](./images/C5/Quicker_20240519_162200.png)
>注：$B[5: 0] = A[2: 0] \times A[2: 0]$

因此，选择$2^3 \times 4$ ROM，框图如下：
![400](./images/C5/Quicker_20240519_162405.png)

真值表：
![200](./images/C5/Quicker_20240519_162437.png)

电路实现：
![](./images/C5/Quicker_20240519_162554.png)
>注：B0和B1并不在可编程阵列中(原因见前面的分析)

#### Programmable Array Logic(PAL)

构成：可编程与门阵列 + 固定或门阵列(与ROM正好相反)
![300](./images/C5/Quicker_20240519_162932.png)
>注：看到与门和或门的交点并不是用$\times$表示的，说明或门阵列是固定的，即对应布尔方程的==乘积项数量是固定的==

可以看出，它不提供所有的最小项，而是产生**乘积项**，然后由或门选择这些乘积项，因此它的输出是SOP

弊：
+ ROM保证实现任意有$N$个输入的$M$个函数，但PAL的或门输入有限
利：
...
![300](./images/C5/Quicker_20240519_164311.png)

电路实现：
![](./images/C5/Quicker_20240519_163847.png)
...
![](./images/C5/Quicker_20240519_164449.png)
...
🌰
1. 3输入-2输出PLA(有4个乘积项)
![](./images/C5/Quicker_20240519_165754.png)
...
电路实现：
![](./images/C5/Quicker_20240519_171646.png)
...
🌰：通过4-1MUX实现的2输入查找表
![500](./images/C5/Quicker_20240519_172226.png)
+ 更大的MUX可以通过利用一组更小的MUX搭建树状结构来实现
🌰：
1. 对上例的改进
![500](./images/C5/Quicker_20240519_172500.png)
2. 用7个2-1MUX形成树状结构，实现3输入LUT
![400](./images/C5/Quicker_20240519_172643.png)
...
![300](./images/C5/Quicker_20240519_174439.png)
