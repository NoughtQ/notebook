...
其中$0 < p < 1$，称$X$服从参数为$p$的**0-1分布**，也称为**两点分布**，并用记号$X \sim 0-1(p)$表示。
...
其中$0 < p < 1, n \ge 1$，则称$X$服从参数$(n, p)$的**二项分布**(binomial distribution)，记为$X \sim B(n, p)$。
...
- 对任意实数$x_1, x_2(x_1 < x_2)$
    ...
    - 由该性质易证$P(X = a) = 0$，即连续型随机变量取任一定值的概率为0。因此，连续型随机变量落在开区间与相应闭区间上的概率相等。
...
??? example "例题"
    ...
    === "问题"
        ...
        <div style="text-align: center">
            <img src="images/C2/15.png" width="50%">
        </div>
