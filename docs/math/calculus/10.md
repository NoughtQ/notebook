...
+ $\iint\limits_S P(x, y, z)\mathrm{d}y\mathrm{d}z = \mathrm{sgn}(\dfrac{\pi}{2} - \alpha) \iint\limits_{\sigma_{yz}} P(x(y, z), y, z)\mathrm{d}\sigma$
+ $\iint\limits_S Q(x, y, z)\mathrm{d}z\mathrm{d}x = \mathrm{sgn}(\dfrac{\pi}{2} - \beta) \iint\limits_{\sigma_{zx}} Q(x, y(x, z), z)\mathrm{d}\sigma$
...
$$
\begin{align}
& \iint\limits_S(\dfrac{\partial R}{\partial y} - \dfrac{\partial Q}{\partial z})\mathrm{d}y\mathrm{d}z + (\dfrac{\partial P}{\partial z} - \dfrac{\partial R}{\partial x})\mathrm{d}z\mathrm{d}x + (\dfrac{\partial Q}{\partial x} - \dfrac{\partial P}{\partial y})\mathrm{d}x\mathrm{d}y \notag \\
