...
???+ note "相关知识"
	...
	+ 在[数逻](../../sys/dld/2.md#exclusive-or-operator-and-gates)中，这种形式也被称为**同或(XNOR)**
...
>注：这里的补充部分与dld高度重合，可以参考[数逻](../../sys/dld/2.md)的部分，那里讲得更加详细
...
>注：该概念类似数逻的["标准形式"](../../sys/dld/2.md#standard-forms)
...
>注：具体参照[数逻](../../sys/dld/2.md#standard-forms-1)**SOP**和**POS**的概念
...
>注：具体参照[数逻](../../sys/dld/2.md#minterms-and-maxterms)**SOM**和**POM**
...
> 注：可以用类似的方法求Full CNF，看下面的例子更好理解，或者看[数逻相应部分](../../sys/dld/2.md#som-and-pom)
