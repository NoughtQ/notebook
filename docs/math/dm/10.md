...
>注：本节对应fds[这部分](../../algo/fds/9.md#euler-circuits)
...
+ **哈密顿路(Hamilton path)**：图G中包含所有*顶点*的简单路径
+ **哈密顿环(Hamilton circuit)**：图G中包含所有*顶点*的简单环
...
+ **格雷码(gray codes)**
>注：具体内容见dld[相关部分](../../sys/dld/1.md#gray-codes)，这里只讲图论中的应用
...
>注：这一节对应fds的[相关部分](../../algo/fds/9.md#shortest-path-algorithms)
...
简单介绍一下流程(更详细的介绍见[这里](../../algo/fds/9.md#dijkstras-algorithmfor-weighted-shortest-paths))：
