...
>+ 具体内容见[数逻](../../hardware/dld/3.md#unsigned-2s-complement-subtraction)


+ **[BCD码](../../hardware/dld/1.md#binary-coded-decimalbcd)**：对于一个整数，它的每个位*分别*用4位二进制表示
...
???+ example "应用"
	...
	=== "**奇偶校验位**"
		...
		>[参考](../../hardware/dld/1.md#error-detection)
