...
>注：
>
>+ [树的知识点](../../algo/fds/4.md)在fds已讲过，可以互为参照，之后考虑合并起来
...
></div>
>
>+ 有根树的其他基本概念(诸如什么是父节点、子节点……)见fds[对应部分](../../algo/fds/4.md#definitions)
...
>注：fds介绍过[类似内容](../../algo/fds/4.md#applicationfile-system)，且更加详细
...
>具体见[fds](../../algo/fds/4.md#the-search-tree-adt----binary-search-tree)，这里就稍微提一下
...
+ 用决策树证明基于比较的排序的时间复杂度([fds](../../algo/fds/7.md#general-lower-bound-for-sorting)已讲过)
