...
后续内容参见笔者的 CG 笔记中关于[反走样](../../software/cg/4.md#antialiasing)的介绍。
...
<div style="text-align: center">
    <img src="images/lec3/38.png" width=30% />
</div>
...
- 使用**边缘能量**(edge energy)作为衡量指标：$E(I) = \left|\dfrac{\partial I}{\partial x}\right| + \left|\dfrac{\partial I}{\partial y}\right|$
    - 对图像而言，可利用**卷积**来求导（回忆前面介绍的[边缘检测器](#edge-detection)）
